...
// 4-2 평균
const avg1 = sum/SSAFY.length
console.log(avg1)
const avg2 = SSAFY.reduce((total, x) => total + x, 0) / SSAFY.length
console.log(avg2)
const avg3 = SSAFY.reduce((total, x) => total + x/SSAFY.length, 0)
console.log(avg3)
...
*/
const arr = [1, 2, 3, 4, 5, ]
const even1 = arr.some(x => x%2 === 0)
console.log(even1)
const even2 = arr.some(x => !(x%2))
console.log(even2)
...
const hasSubmitted = USERS1.every(function (user) {
